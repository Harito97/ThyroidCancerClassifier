...
def load_data(data_dir:str, batch_size:int=32, num_workers:int=4, classes:dict={0: ["B2"], 1: ["B5"], 2: ["B6"]}):
    """
    ...
    train_dataset = ThyroidCancerDataset(data_dir=data_dir, transform=None, classes=classes, balance=True, mode='train')
